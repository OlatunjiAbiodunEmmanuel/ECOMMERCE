...
const NavBar = () => {
  ...
  return (
    ...
    <nav class="navbar d-lg-none bg-body-tertiary fixed-top">
            ...
            <a class="navbar-brand" href="#" style={{fontWeight:'bolder'}}><img src={logo} style={{width:'60px', borderRadius:'50%',marginRight:'5%'}} />QQQQ</a>
              ...
              <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                <div class="offcanvas-header">
                  <h5 class="offcanvas-title" id="offcanvasNavbarLabel">QQQQ</h5>
